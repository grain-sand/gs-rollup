...
`;
    ...
    const expected = `import foo, { bar, baz } from './module1';

console.log(foo, bar, baz);
`;
    const result = margeEsImport(code);
...
`;
    ...
    const expected = `import foo, { baz } from './module1';
import { bar } from './module2';
...
`;
    ...
    const expected = `import foo, { bar } from './module1';
